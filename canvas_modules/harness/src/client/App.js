...
import LinkTypesCanvas from "./components/custom-canvases/link-types/link-types-canvas";
...
class App extends React.Component {
	...
	getCanvasConfig() {
		const canvasConfig = {
			...
			enableSplitLinkDroppedOnNode: this.state.selectedSplitLinkDroppedOnNode,
			...
			enableMarkdownHTML: this.state.selectedMarkdownHTML,
			enableWYSIWYGComments: this.state.selectedWYSIWYGComments,
			enableMoveNodesInComment: this.state.selectedMoveNodesInComment,
	...
	render() {
		...
		} else if (this.state.selectedExampleApp === EXAMPLE_APP_LINK_TYPES) {
			firstCanvas = (
				<LinkTypesCanvas
					ref={this.canvasRef}
					config={commonCanvasConfig}
