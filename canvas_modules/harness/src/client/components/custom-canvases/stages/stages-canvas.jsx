...
export default class StagesCanvas extends React.Component {
	...
	getDecorationsArray(linkLabel) {
		const decs = [
			...
			{ id: "dec-1", focusable: true, position: "source", image: "images/custom-canvases/stages/decorations/tri-up.svg", class_name: "det-tri",
				distance: 40, x_pos: -7, y_pos: -7, width: 14, height: 14, outline: true, tooltip: "Up Triangle", temporary: true },
			{ id: "dec-2", focusable: true, position: "target", image: "images/custom-canvases/stages/decorations/tri-down.svg", class_name: "det-tri",
			...
			{ id: "link-label", focusable: true, position: "middle", label: linkLabel, label_editable: true, label_allow_return_key: "save",
