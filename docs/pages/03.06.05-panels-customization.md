...
Common Canvas provides [6 panels](01.09-panels.md) that can be displayed or hidden by the application as required:
...
This is displayed at the top of the area that Common Canvas occupies and only ever displays the main toolbar.
